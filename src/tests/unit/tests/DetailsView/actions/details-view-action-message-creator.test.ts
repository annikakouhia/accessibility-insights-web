...
describe('DetailsViewActionMessageCreatorTest', () => {
    ...
    test('addFailureInstanceWithDescriptionAndPath', () => {
        const telemetry = {
            source: TelemetryEventSource.DetailsView,
            triggeredBy: TriggeredByNotApplicable,
            selectedRequirement: 'requirement',
    ...
    test('addFailureInstanceWithOnlyDescription', () => {
        const telemetry = {
            source: TelemetryEventSource.DetailsView,
            triggeredBy: TriggeredByNotApplicable,
            selectedRequirement: 'requirement',
        ...
        testSubject.addFailureInstance('description', null, null, 1, 'requirement');
