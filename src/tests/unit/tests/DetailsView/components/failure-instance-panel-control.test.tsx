...
describe('FailureInstancePanelControlTest', () => {
    ...
    test('onSaveEditedFailureInstance', () => {
        ...
        editInstanceMock
            .setup(handler => handler(description, null, null, props.test, props.step, props.instanceId))
    ...
    test('onAddFailureInstance', () => {
        ...
        addInstanceMock.setup(handler => handler(description, null, null, props.test, props.step)).verifiable(Times.once());
        const wrapper = shallow<FailureInstancePanelControl>(<FailureInstancePanelControl {...props} />);
